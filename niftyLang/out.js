...
break;
case 1:return getToken('VAR');
break;
case 2:return getToken('NUMBER');
break;
case 3:return getToken('*');
break;
case 4:return getToken('/');
break;
case 5:return getToken('-');
break;
case 6:return getToken('+');
break;
case 7:return getToken('^');
break;
case 8:return getToken('(');
break;
case 9:return getToken(')');
break;
case 10:return getToken('[');
break;
case 11:return getToken(']');
break;
case 12:return getToken('{');
break;
case 13:return getToken('}');
break;
case 14:return getToken('STRING');
break;
case 15:return getToken('EOF');
break;
}
},
rules: [/^(?:\s+)/,/^(?:var\b)/,/^(?:[0-9]+(\.[0-9]+)?\b)/,/^(?:\*)/,/^(?:\/)/,/^(?:-)/,/^(?:\+)/,/^(?:\^)/,/^(?:\()/,/^(?:\))/,/^(?:\[)/,/^(?:\])/,/^(?:\{)/,/^(?:\})/,/^(?:[a-zA-Z]+)/,/^(?:$)/],
